...
class AddOp(Op):
    ...
    def infer_shape(self, node, input_shapes):
        ...
        if input_shapes[0] == input_shapes[1] or input_shapes[1] == (1,):
            return input_shapes[0]
        return input_shapes[1] if input_shapes[0] == (1,) else None
...
class MatMulOp(Op):
    ...
    def infer_shape(self, node, input_shapes):
        ...
        elif (node.matmul_attr_trans_A and node.matmul_attr_trans_B):
...
class ZerosLikeOp(Op):
    ...
    def infer_shape(self, node, input_shapes):
        ...
        """TODO: Your code here(Done)"""
        assert len(input_shapes) == 1
        return (1,) if len(input_shapes[0]) == 1 else input_shapes[0]
...
class ReduceSumAxisZeroOp(Op):
    ...
    def infer_shape(self, node, input_shapes):
        ...
        """TODO: Your code here(Done)"""
        assert len(input_shapes) == 1
        return (1,) if len(input_shapes[0]) == 1 else input_shapes[0][1:]
...
class Executor(object):
    ...
    def memory_plan(self, feed_shapes):
        ...
        for node, shape in self.node_to_shape_map.items():
            arr_node = None
            if node in feed_shapes:	  continue
